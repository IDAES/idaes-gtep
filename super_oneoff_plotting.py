...
def plot_binaries(dict_in, suptitle):
...
# read gen info
gens_pd = pd.read_csv("gen.csv")

this_json = read_json("./dispatchable_investments 2.json")
this_dict = to_dict(this_json)
plot_binaries(this_dict, "Dispatchable Investments")

this_json = read_json("./renewable_investments 2.json")
this_dict = to_dict(this_json)
plot_binaries(this_dict, "Renewable Investments")
