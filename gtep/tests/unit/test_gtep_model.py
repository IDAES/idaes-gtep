...
class TestGTEP(unittest.TestCase):
    ...
    def test_solve_bigm(self):
        ...
        # previous successful objective values: 9207.95, 6078.86, 531860.15, 531883.43, 7977055.4, 7977055.4, 7977150.30, 6986122.88
        self.assertAlmostEqual(
            value(modObject.model.total_cost_objective_rule), 7130508.88, places=1
        )
    ...
    def test_no_investment(self):
        ...
        # previous successful objective values: 531860.15, 531883.43, 7977055.4, 7977055.4, 7977150.30, 6986122.88
        self.assertAlmostEqual(
            value(modObject.model.total_cost_objective_rule), 7977169.84, places=1
        )
    ...
    def test_with_cost_data_and_commitment(self):
        ...
        # previous successful objective values: 1524581869.89, 779334165.7, 779344643.1, 779486340.91, 776765960.70
        self.assertAlmostEqual(
    ...
    def test_with_cost_data_and_weights(self):
        ...
        self.assertAlmostEqual(
            value(modObject.model.total_cost_objective_rule), 3507349322.70, places=1
        )
    ...
    def test_with_cost_data_and_hydro(self):
        ...
        self.assertAlmostEqual(
            value(modObject.model.total_cost_objective_rule), 767708848.64, places=1
        )
        assert_units_equivalent(modObject.model.total_cost_objective_rule.expr, u.USD)
