...
with open(
    "retirement_allowed_extreme_fixed_load/renewable_investments.json", "w"
) as fil:
    json.dump(renewable_investments, fil)
with open(
    "retirement_allowed_extreme_fixed_load/dispatchable_investments.json", "w"
) as fil:
    json.dump(dispatchable_investments, fil)
with open("retirement_allowed_extreme_fixed_load/load_shed.json", "w") as fil:
